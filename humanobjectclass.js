...
class HumanObject{
    ...
    move(){
        ...
        if (keyCode == LEFT_ARROW || this.turnLeftInMotion == true) {
            if(this.objectState == "front" || this.turnLeftInMotion == true){
                ...
                if( this.step < 1.0){
                    ...
                    this.objectArray[0][17] =   this.objectArray[0][18] + sqrt(pow(this.dimensionArray[0][1],2) - pow(3 * innerWidth / screen.width * this.step, 2));
                    ...
                    this.objectArray[1][4]  =   this.objectArray[1][3] + sqrt(pow(this.dimensionArray[0][11],2) - pow((40 * innerWidth / screen.width),2));
                    // left wrist
                    this.objectArray[0][5]  =   this.objectArray[0][4] - (100 * innerWidth / screen.width) * this.step
                    ...
                    // right elbow
                    this.objectArray[0][7]  =   this.objectArray[0][6] + (40 * innerWidth / screen.width) * this.step;
                    this.objectArray[1][7]  =   this.objectArray[1][6] + sqrt(pow(this.dimensionArray[0][9],2) - pow((40 * innerWidth / screen.width),2));
                    // right writs
